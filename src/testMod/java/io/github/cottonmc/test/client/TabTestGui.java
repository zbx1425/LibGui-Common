...
public class TabTestGui extends LightweightGuiDescription {
	public TabTestGui() {
		...
		tabs.add(new WKirbSprite(), builder -> builder.title(Component.literal("Kirb")));
		tabs.add(new WLabel(Component.literal("just another tab")), builder -> builder.icon(new ItemIcon(Items.ANDESITE)));
